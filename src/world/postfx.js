...
// Post-processing chain: scene -> subtle bloom -> ACES output.
//
// Bloom makes the sun, lit signs, glowing windows and night streetlamps
// bleed light the way real cameras do. OutputPass applies ACES tone
// mapping + sRGB at the very end of the chain (the modern three.js recipe),
// so intermediate passes work in linear HDR.
//
...
// always runs, it just loses the glow.
