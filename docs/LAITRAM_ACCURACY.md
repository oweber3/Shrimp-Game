...
| Intralox Plant "(220 Plantation)" | Public sources put Intralox at **301 Plantation Rd**; "220 Plantation" is not publicly corroborated | ⚠️ **Flagged** — either relabel the big plant as part of the 301 complex, or keep "220 Plantation" as internal-style numbering (Open Question #6 in REALISM_PLAN.md) |
